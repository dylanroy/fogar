...
export type { WidgetCtx, WidgetDef } from './shared';
import { BOOKMARK, ago, cacheKey, favicon, host, setupForm, type WidgetCtx, type WidgetDef } from './shared';
...
export const WIDGETS: WidgetDef[] = [todos, reminders, agenda, sessions, writing, email, feed, jira, chat, canvas, notebook, postit, links, notes, weather, recipe];
