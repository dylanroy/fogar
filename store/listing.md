...
- Data the user enters is stored locally. When the user configures a cloud endpoint, search provider, calendar feed, or weather city, requests go only to that address.
