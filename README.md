...
Release candidate v0.1.0. Everything below works end to end and is covered by `npm run test:spike`, which loads the built extension into Chromium and runs 75 checks against local mock servers.
