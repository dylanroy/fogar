...
export default defineConfig({
  ...
  manifest: ({ command }) => ({
    ...
    short_name: 'Fogar',
    description:
      'A private new tab. Ask anything; answers come from a model running in your browser, or a cloud endpoint you bring your own key for.',
    ...
    // `identity` is asked for only when the Email widget connects Gmail through the user's own OAuth client.
    optional_permissions: ['tabs', 'identity'],
